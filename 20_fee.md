...
現状、以下の場合にエアコンを使っています：
* 夏季：[暑さ指数（WBGT）](https://www.wbgt.env.go.jp/wbgt.php)に基づく警戒レベルが高い場合。
* 冬季：道場の温度が10℃を下回る場合。
...
小銭の利用を減らすため、運営費の支払いは下記の回数券をご利用ください。
{:.warning}

### 3.2. 回数券
{:#coupon}

運営費に関してはまとめ買いのチケット（6回分の回数券）がありますので、原則こちらをご利用ください：
