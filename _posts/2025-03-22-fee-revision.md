...
1. 空調費が新設されます &mdash; アンケートの結果を受け、空調利用のための費用を負担していただくことにします。空調費は2025年度は一人1,000円です。

空調費については、利用実績をベースに適宜改定します。
{:.warning}

詳細については {% include link.html path="20_fee.md" %} を参照してください。
